...
import uk.gov.hmrc.vo.tctr.backend.models.aboutYourLeaseOrTenure.{AboutLeaseOrAgreementPartFour, AboutLeaseOrAgreementPartOne, AboutLeaseOrAgreementPartThree, AboutLeaseOrAgreementPartTwo}
...
import uk.gov.hmrc.vo.tctr.backend.models.aboutyouandtheproperty.{AboutYouAndTheProperty, AboutYouAndThePropertyPartTwo}
...
import uk.gov.hmrc.vo.tctr.backend.models.connectiontoproperty.StillConnectedDetails
import uk.gov.hmrc.vo.tctr.backend.models.lettingHistory.LettingHistory
import uk.gov.hmrc.vo.tctr.backend.models.notconnected.RemoveConnectionDetails
import uk.gov.hmrc.vo.tctr.backend.models.requestReferenceNumber.RequestReferenceNumberDetails
