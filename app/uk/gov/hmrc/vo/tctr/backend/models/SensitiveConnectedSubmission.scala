...
import uk.gov.hmrc.vo.tctr.backend.models.aboutYourLeaseOrTenure.{AboutLeaseOrAgreementPartFour, AboutLeaseOrAgreementPartThree, AboutLeaseOrAgreementPartTwo, SensitiveAboutLeaseOrAgreementPartOne}
import uk.gov.hmrc.vo.tctr.backend.models.aboutfranchisesorlettings.AboutFranchisesOrLettings
import uk.gov.hmrc.vo.tctr.backend.models.aboutthetradinghistory.{AboutTheTradingHistory, AboutTheTradingHistoryPartOne}
import uk.gov.hmrc.vo.tctr.backend.models.aboutyouandtheproperty.{AboutYouAndThePropertyPartTwo, SensitiveAboutYouAndTheProperty}
import uk.gov.hmrc.vo.tctr.backend.models.accommodation.AccommodationDetails
import uk.gov.hmrc.vo.tctr.backend.models.additionalinformation.AdditionalInformation
import uk.gov.hmrc.vo.tctr.backend.models.connectiontoproperty.SensitiveStillConnectedDetails
import uk.gov.hmrc.vo.tctr.backend.models.lettingHistory.SensitiveLettingHistory
import uk.gov.hmrc.vo.tctr.backend.models.notconnected.SensitiveRemoveConnectionDetails
import uk.gov.hmrc.vo.tctr.backend.models.requestReferenceNumber.SensitiveRequestReferenceNumber
