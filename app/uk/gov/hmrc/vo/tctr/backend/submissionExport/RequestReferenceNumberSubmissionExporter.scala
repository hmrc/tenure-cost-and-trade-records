...
import uk.gov.hmrc.vo.tctr.backend.infrastructure.{LockedJobScheduler, Schedule}

import scala.concurrent.duration.DurationInt
import scala.concurrent.{ExecutionContext, Future}
import scala.language.postfixOps

class RequestReferenceNumberSubmissionExporter(
  mongoLockRepository: MongoLockRepository,
  exporter: ExportRequestReferenceNumberSubmissions,
  exportBatchSize: Int,
  scheduler: Scheduler,
